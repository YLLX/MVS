...
import rpc_utils
import estimation
from rectification import filter_matches_epipolar_constraint
...
def matches_on_rpc_roi(im1, im2, rpc1, rpc2, x, y, w, h,
    ...
    for _ in range(2):
        ...
        matches = keypoints_match(p1, p2, method, sift_thresh, F,
                                  ...
                                  model='fundamental', ransac_max_err=0.5)
        matches = filter_matches_epipolar_constraint(F, matches, cfg['epipolar_thresh'])
